    ...
    spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Bitcoin UL") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    aboutAction = new QAction(TextColorIcon(":/icons/about"), tr("&About Bitcoin UL"), this);
    aboutAction->setStatusTip(tr("Show information about Bitcoin UL"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Bitcoin UL"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Bitcoin UL help message to get a list with possible Bitcoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Bitcoin UL client") + " " + networkStyle->getTitleAddText();
